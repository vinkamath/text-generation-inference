...
class WeightsLoader(ABC):
    ...
    def get_multi_weights_col(
        self, weights: "Weights", prefixes: List[str], dim: int
    ): ...
...
class _DefaultWeightsLoader(WeightsLoader):
    """
    This loader uses tensors as-is with the exception of applying sharding
    ...
    def get_weights_col(self, weight: "Weights", prefix: str):
...
class Weights:
    def __init__(
        ...
        self.prefix = prefix
        self.weights_loader = (
            _DefaultWeightsLoader() if weights_loader is None else weights_loader
        )
        self._handles = {}
    ...
    def get_multi_weights_row(self, prefix: str):
        return self.weights_loader.get_multi_weights_row(self, prefix)
